...
#let project(
  ...
  major: none,
  cover_comments: none,
  cover_comments_size: 1.5em,
  language: none,
  table_of_contents: none,
  font_serif: ("New Computer Modern", "Times New Roman", "Noto Serif SC"),
  font_sans_serif: "Noto Serif SC",
  ...
  set text(font: font_serif, lang: language, size: 14pt)
  show raw: set text(font: font_mono, size: 12pt)
  ...
  if (theme == "lab") {
    v(1fr)
    // align(center, image("./images/ZJU-Banner.png", width: 70%))
  ...
  set page(
    header: [#set text(7.5pt)
      #fakebold[#course]
      #h(1fr) #fakebold[#title]
  ...
  set table(align: center + horizon, stroke: 0.3pt)
